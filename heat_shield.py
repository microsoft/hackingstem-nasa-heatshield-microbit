...
TMP36_INTERNAL_PIN = pin2
TMP36_EXTERNAL_PIN = pin1
TMP36_AIR_PIN = pin0
...
uart.write(EOL+"INIT,0,0"+EOL)


while True:
    internal_celcius = read_temp(TMP36_INTERNAL_PIN)
    external_celcius = read_temp(TMP36_EXTERNAL_PIN)
    air_celcius = read_temp(TMP36_AIR_PIN)

    uart.write(",{},{},{}".format(internal_celcius,external_celcius,air_celcius)+EOL)
